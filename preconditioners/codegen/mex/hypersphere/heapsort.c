...
static void c_heapify(int32_T x[196], int32_T idx, int32_T xstart,
                      int32_T xend);

static void heapify(int32_T x[298], int32_T idx, int32_T xstart, int32_T xend);
...
static void c_heapify(int32_T x[196], int32_T idx, int32_T xstart, int32_T xend)
{
  int32_T extremum;
  int32_T extremumIdx;
  int32_T leftIdx;
...
void b_heapsort(const emlrtStack *sp, int32_T x[298], int32_T xstart,
                int32_T xend)
{
  emlrtStack b_st;
  emlrtStack st;
...
void d_heapsort(const emlrtStack *sp, int32_T x[196], int32_T xstart,
                int32_T xend)
{
  emlrtStack b_st;
  emlrtStack st;
