 ...
 *
 * qr_preconditioner_emxutil.c
 *
 * Code generation for function 'qr_preconditioner_emxutil'
 *
 */
...
void emxFreeStruct_sparse1(const emlrtStack *sp, c_sparse *pStruct)
{
  emxFree_real_T(sp, &pStruct->d);
  emxFree_int32_T(sp, &pStruct->colidx);
  emxFree_int32_T(sp, &pStruct->rowidx);
...
void emxInitStruct_sparse1(const emlrtStack *sp, c_sparse *pStruct,
                           const emlrtRTEInfo *srcLocation)
{
  emxInit_real_T(sp, &pStruct->d, 1, srcLocation);
  emxInit_int32_T(sp, &pStruct->colidx, srcLocation);
...
/* End of code generation (qr_preconditioner_emxutil.c) */
