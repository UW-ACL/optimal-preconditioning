% POWER_ITERATION_DENSE_SCRIPT   Generate MEX-function power_iteration_dense_mex
%  from power_iteration.
% 
% Script generated from project 'power_iteration.prj' on 31-Mar-2025.
% 
...
ARGS = cell(1,1);
ARGS{1} = cell(2,1);
ARGS{1}{1} = coder.typeof(0,[196 298]);
ARGS_1_2 = struct;
...
codegen -config cfg -o power_iteration_dense_mex power_iteration -args ARGS{1}